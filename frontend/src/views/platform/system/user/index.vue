  ...
  <div class="user-page">
    ...
    <el-card shadow="never" class="table-card">
      <div class="table-header">
        <el-button v-permission="'platform:user:create'" type="primary" @click="openCreateDialog">
          新增用户
        </el-button>
      </div>
      ...
      <el-table v-loading="loading" :data="tableData" border stripe style="width: 100%">
        ...
        <el-table-column label="操作" width="260" fixed="right">
          <template #default="{ row }">
            <el-button v-permission="'platform:user:update'" type="primary" link size="small" @click="openEditDialog(row)">
              编辑
            </el-button>
            <el-button v-permission="'platform:user:assign'" type="warning" link size="small" @click="openAssignDialog(row)">
              分配角色
            </el-button>
            <el-button v-permission="'platform:user:reset'" type="info" link size="small" @click="openResetDialog(row)">
              重置密码
            </el-button>
            <el-button v-permission="'platform:user:delete'" type="danger" link size="small" @click="handleDelete(row)">
              删除
            </el-button>
          </template>
        </el-table-column>
