...
<template>
  <div class="dept-container">
    <div class="dept-header">
      <el-button v-permission="'platform:dept:create'" type="primary" @click="handleCreate">
        新增顶级部门
      </el-button>
    ...
    >
      ...
      <el-table-column label="操作" width="220" fixed="right">
        <template #default="{ row }">
          <el-button
            v-permission="'platform:dept:create'"
            link
            type="primary"
            size="small"
          ...
          <el-button
            v-permission="'platform:dept:update'"
            link
            type="primary"
            size="small"
          ...
          <el-button
            v-permission="'platform:dept:delete'"
            link
            type="danger"
            size="small"
