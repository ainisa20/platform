...
<template>
  <div class="role-page">
    ...
    <div class="action-bar">
      <el-button v-permission="'platform:role:create'" type="primary" @click="openCreateDialog">
        新增角色
      </el-button>
    </div>
    ...
    <el-table :data="tableData" v-loading="loading" border stripe style="width: 100%">
      ...
      <el-table-column label="操作" width="220" fixed="right">
        <template #default="{ row }">
          <el-button v-permission="'platform:role:update'" type="primary" link size="small" @click="openEditDialog(row)">
            编辑
          </el-button>
          <el-button v-permission="'platform:role:assign'" type="primary" link size="small" @click="openPermDialog(row)">
            分配权限
          </el-button>
          <el-button v-permission="'platform:role:delete'" type="danger" link size="small" @click="handleDelete(row)">
            删除
          </el-button>
        </template>
      </el-table-column>
